...
const companies = [
  {
    ...
    order: 1,
    metrics: [
      { _key: "m1", label: "Revenue Growth", value: "+186%" },
      { _key: "m2", label: "YoY", value: "3.2x" },
      { _key: "m3", label: "Markets", value: "4" },
    ],
  },
  {
    ...
    order: 2,
    metrics: [
      { _key: "m1", label: "GMV Growth", value: "+142%" },
      { _key: "m2", label: "Freelancers", value: "18K+" },
      { _key: "m3", label: "Clients", value: "8K+" },
    ],
  },
  {
  ...
  },
  {
    ...
    metrics: [
      ...
      { _key: "m2", label: "", value: "Content, SaaS," },
      { _key: "m3", label: "Focus", value: "Marketplaces" },
    ],
  },
];
